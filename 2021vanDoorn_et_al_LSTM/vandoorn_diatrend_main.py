...
def main_diatrend(fold_number):
    ...
    This function handles both training and evaluation across multiple folds.
    """
    # 5-FOLD CROSS VALIDATION
    # for fold_number in range(1, 6):
        # Training phase
    yaml_filepath = f"./vandoorn_diatrend_experiments_30min/all_final_experiment_fold{fold_number}.yaml"
    mode = "train"
    ...
    # Evaluation phase
    yaml_files = glob.glob(f"./vandoorn_diatrend_experiments_30min/fold{fold_number}_eval/*.yaml")
    mode = "evaluate"
