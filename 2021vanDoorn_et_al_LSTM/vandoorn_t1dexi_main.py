...
def main_t1dexi(fold_number):
    ...
    """
    tuning_sp = 30  # Fixed tuning_sp value
    # 5-fold cross-validation
    # for fold_number in range(1, 6):
        # Training phase
    yaml_filepath = f"./vandoorn_t1dexi_experiments_{tuning_sp}min/all_final_experiment_fold{fold_number}.yaml"
    mode = "train"
    ...
    # Evaluation phase
    yaml_files = glob.glob(f"./vandoorn_t1dexi_experiments_{tuning_sp}min/fold{fold_number}_eval/*.yaml")
    mode = "evaluate"
