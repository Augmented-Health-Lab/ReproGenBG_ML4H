...
from cgms_data_seg_t1dexi import CGMSDataSeg  # Assuming CGMSDataSeg is defined in cgms_data_seg.py
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='T1DEXI dataset processing and model training')
